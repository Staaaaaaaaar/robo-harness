...
REQUIRED_PATHS = (
    ...
    "deployment/compose/compose.isaac.yaml",
    "deployment/compose/compose.mock.yaml",
    "deployment/docker/dev/Dockerfile",
    "deployment/docker/env/Dockerfile",
    ...
    "simulators/isaac/apps/rh.kit",
    "simulators/isaac/extensions/rh.isaac/config/extension.toml",
    "tasks/README.md",
    "tests/README.md",
    "tools/README.md",
    "tools/dev/run_isaac_gui.sh",
    "tools/e2e/run_mock_compose.sh",
    "tools/e2e/run_isaac_bridge_smoke.sh",
    "tools/e2e/validate_mock_result.py",
    "tools/validation/check_isaac_skeleton.py",
)
